...
ROOT_REL="${1:-drqn_aequitas_appmix_ue20_sim2_eval5x10_ep200_step001_harq_monitor_20260403}"
RUN_ROOT="scratch/rl_bwp/runs/${ROOT_REL}"
TRAIN_ROOT="${RUN_ROOT}/drqn_aeq_train"
...
nohup ./scratch/rl_bwp/monitor_ns3_reconnector.sh \
  ...
  --aequitasEnableMcsSelection=true \
  --enableHarqReTx=true \
  --rlDrqnProfile=true \
...
for seed in "${EVAL_SEEDS[@]}"; do
  ...
  ./ns3gym-venv/bin/python3 -u scratch/rl_bwp/eval_drqn.py \
    --backend ns3 \
